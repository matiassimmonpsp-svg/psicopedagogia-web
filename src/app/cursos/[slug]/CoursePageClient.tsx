...
import { areas, subareas, getCourseBySlug, type Resource } from '@/lib/data'
...
export default function CoursePageClient({ params, searchParams }: { params: { slug: string }; searchParams: { area?: string; subarea?: string } }) {
  ...
  const filteredResources = useMemo(() => resources.filter((r: Resource) => {
    ...
    return true
  }), [resources, selectedAreaSlug, selectedSubareaSlug])
